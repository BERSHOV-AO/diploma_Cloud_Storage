 ...
 * Данная строка представляет собой объявление метода uploadFile, который будет обрабатывать POST-запрос на загрузку файла.
 * <p>
 ...
 * Аргумент @RequestParam("filename") указывает на то, что входной параметр filename будет получен из параметра запроса с именем "filename".
 * Параметр MultipartFile file представляет сам загружаемый файл. Он будет автоматически привязан к загруженному файлу из запроса.
 * <p>
